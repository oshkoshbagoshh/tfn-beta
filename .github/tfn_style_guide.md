...
<pre class="c-mrkdwn__pre" data-stringify-type="pre">``<div class="p-rich_text_block--no-overflow">`
...
Ensure that all combinations meet accessibility standards for contrast, especially for users with visual impairments.`</div></pre>`

## style.css (with everything )

<pre class="c-mrkdwn__pre" data-stringify-type="pre"><div class="p-rich_text_block--no-overflow">css
...
/_ TFN Branding Stylesheet _//_ Color Palette _/
:root {
--indigo: #440381
...
@import url(‘[https://fonts.googleapis.com/css2?family=Rubik:wght@700&amp;family=Open+Sans:wght@400;700&amp;display=swap](https://fonts.googleapis.com/css2?family=Rubik:wght@700&family=Open+Sans:wght@400;700&display=swap)’);body {
font-family: ‘Open Sans’, sans-serif;
...
color: white;
}/_ Add more specific styles as needed _/
...
![](https://ca.slack-edge.com/T07FX92K8KZ-U07J9EQ7S4T-gae4abf3fc30-48)
```
